...
contract AuctionFactory {
    ...
    function createAuction(uint endBid, address _oracle, string memory _product) public returns(uint) {
        auctionNum++;
    ...
    function placeBid(uint auctionID)public
        payable
    ...
    function getIsEnd(uint auctionID) public view returns (bool){   //determine if it is ended
    ...
    function getHighestBid(uint auctionID)public
        view
        returns (uint)
    {
    ...
    function getHighestBidderAddress(uint auctionID)public
        view
        returns (address)
    {
    ...
    function getBidNum(uint auctionID)public
        view
        returns (uint)
    {
    ...
    function getOwnerAddress(uint auctionID)public
        view
        returns (address)
    {
    ...
    function getProductName(uint auctionID)public
        view
